// components/cards/ArticleCardContentLeftImageRight.tsx
...
interface ArticleCardContentLeftImageRightProps {
  article: Article;
}

const ArticleCardContentLeftImageRight: React.FC<ArticleCardContentLeftImageRightProps> = ({ article }) => {
  return (
...
export default ArticleCardContentLeftImageRight;